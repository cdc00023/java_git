...
public class UserManager extends JFrame {
	...
	//기능에 따라 버튼 비활성처리 목적, 전역변수화
	private JButton btnUpdate;
	private JButton btnSave;
	private JButton btnDelete;
	private JButton btnReset; 
	private JComboBox cmbSrchCriteria;
	private String srchString;
	private JRadioButton rdoLike;
...
//				txtAddress.setText("");
		...
		btnSave.setBounds(138, 10, 97, 57);
		...
		btnReload.setBounds(138, 76, 97, 23);
		panel_Buttons.add(btnReload);
