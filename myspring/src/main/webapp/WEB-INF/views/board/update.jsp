...
<link
	href="https://fonts.googleapis.com/css2?family=Gaegu:wght@700&family=Poor+Story&display=swap"
	rel="stylesheet">
<style>
* {
	margin: 0; /*바깥여백*/
		...
		<div id="section">
			<div id="article">
				...
				<form method="post" action="/board/update">
					...
					<table border="1">
						<tr>
							<td class="board_inputA">번호</td>
							<td class="board_inputB"><input type="text" name="b_num"
								value="${board.b_num}" readonly></td>
						</tr>
						<tr>
							<td class="board_inputA">제목</td>
							<td class="board_inputB"><input type="text" name="b_subject"
								value="${board.b_subject}"></td>
						</tr>
						<tr>
							<td class="board_inputA">내용</td>
							<td class="board_inputB"><textarea name="b_contents"
									cols="50" rows="12">${board.b_contents}</textarea></td>
						</tr>
						<tr>
							<td class="board_inputA">작성자</td>
							<td class="board_inputB"><input type="text" name="b_name"
								value="${board.b_name}"></td>
						</tr>
						<tr>
							<td class="board_inputA">작성일</td>
							<td class="board_inputB">${board.b_wdate}</td>
						</tr>
						<tr>
							<td class="board_inputA">수정일</td>
							<td class="board_inputB">${board.b_udate}</td>
						</tr>
						<tr>
							<td class="board_inputA">비밀번호</td>
							<td class="board_inputB"><input type="password"
								name="b_password"></td>
						</tr>
						<tr>
