...
<body>
    ...
    <div id="contents">
		...
		<div id="section">
			<div id="article">
				<p class="title">
					상세보기&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="/board/list?pageNum=${page.pageNum}">리스트</a>
				</p>
				<p>${page.pageNum}</p>
				<form method="post" action="/board/delete">
					...
					<table border="1">
						...
						<tr>
							...
							<td class="board_inputB"><input type="password" name="b_password">
								</td>
						</tr>
						<tr>
							<td class="board_inputA" colspan="2"><a href="/board/list?pageNum=${page.pageNum}">리스트</a>
