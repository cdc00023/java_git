...
<body>
    ...
    <div id="header">
        <img src="http://placeimg.com/900/150">
    </div>
    <div id="nav">
        <div id="main_lnb">
            <ul>
            ...
            <div id="article">
                ...
                <table border="1">
                    ...
                    <tr>
                        ...
                        <td class="board_contents5">15</td>
                    </tr>
                    <tr>
                        <td class="board_contents1">2</td>
                        <td class="board_contents2">하이</td>
                        <td class="board_contents3">마이클</td>
                        <td class="board_contents4">2021-01-11</td>
                        <td class="board_contents5">35</td>
                    </tr>
                    <tr>
                        <td class="board_contents1">3</td>
                        <td class="board_contents2">헬로우</td>
                        <td class="board_contents3">잭슨</td>
                        <td class="board_contents4">2021-01-11</td>
                        <td class="board_contents5">23</td>
                    </tr>
                    <tr>
                        <td class="board_contents1">4</td>
                        <td class="board_contents2">하와유</td>
                        <td class="board_contents3">둘리</td>
                        <td class="board_contents4">2021-01-11</td>
                        <td class="board_contents5">1</td>
                    </tr>
                    <tr>
                        <td class="board_contents1">5</td>
                        <td class="board_contents2">구텐모르겐</td>
                        <td class="board_contents3">프랑크</td>
                        <td class="board_contents4">2021-01-11</td>
                        <td class="board_contents5">5</td>
                    </tr>
                    <tr>
                        <td class="board_contents1">6</td>
                        <td class="board_contents2">나마스테</td>
                        <td class="board_contents3">탄냐</td>
                        <td class="board_contents4">2021-01-11</td>
                        <td class="board_contents5">13</td>
                    </tr>
                    <tr>
                        <td class="board_contents1">7</td>
                        <td class="board_contents2">봉주르</td>
                        <td class="board_contents3">에쉬</td>
                        <td class="board_contents4">2021-01-11</td>
                        <td class="board_contents5">25</td>
                    </tr>
                    <tr>
                        <td class="board_contents1">8</td>
                        <td class="board_contents2">니하오</td>
                        <td class="board_contents3">장저우</td>
                        <td class="board_contents4">2021-01-11</td>
                        <td class="board_contents5">1</td>
                    </tr>
                    <tr>
                        <td class="board_contents1">9</td>
                        <td class="board_contents2">오하요</td>
                        <td class="board_contents3">사와다</td>
                        <td class="board_contents4">2021-01-11</td>
                        <td class="board_contents5">23</td>
                    </tr>
                    <tr>
                        <td class="board_contents1">10</td>
                        <td class="board_contents2">사와디캅</td>
                        <td class="board_contents3">차오엔</td>
                        <td class="board_contents4">2021-01-11</td>
                        <td class="board_contents5">5</td>
                    </tr>
                </table>
